...
public class ReporteServiceImplTest {
    ...
    @Test
    void testSave() {
        doNothing().when(repository).save(any(Reporte.class));
        
        reporteService.save(reporte1);
        
        verify(repository, times(1)).save(reporte1);
    }
    ...
    void testDeleteById_NoExistente() {
        ...
        assertThrows(RuntimeException.class, () -> reporteService.deleteById(99L));
